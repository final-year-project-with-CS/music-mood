                                ...
                                <div class="row">
                                        <div class="col-lg-3">
                                                <div class="card">
                                                        <div class="card-image">
                                                                <img src="assets\images\song.png" height="160px" width="200px" alt="image" class="">
                                                        </div>
                                                        <div class="card-footer">
                                                                <div class="text-center">
                                                                        <i class="link-icon" data-feather="pause"></i>
                                        ...
                                        <div class="col-lg-8">
                                                <div class="row">
                                                        ...
                                                        <h3 class="display-4 mt-1 text-success  "><b>{{ $song->song_file }}</b></h3>
